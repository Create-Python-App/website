export const SITE_URL = 'https://create-awesome-python-app.vercel.app';
export const SITE_NAME = 'Create Awesome Python App';
export const SITE_DESCRIPTION =
  'Discover production-ready templates and extensions to jumpstart your next Python project. Combine starters and add-ons to build faster with uv.';
